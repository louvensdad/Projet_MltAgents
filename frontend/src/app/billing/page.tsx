    ...
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-8 lg:py-10">
      <HolographicCard className="p-6 md:p-8">
        <div className="flex flex-wrap items-center gap-2">
          <AnimatedBadge tone="emerald">billing</AnimatedBadge>
          <AnimatedBadge tone="violet">agent boost</AnimatedBadge>
        </div>
        <div className="mt-5 grid gap-8 xl:grid-cols-[1.15fr_0.85fr]">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-white md:text-5xl">{t("billing.title")}</h1>
            <p className="text-slate-300">{t("billing.subtitle")}</p>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {plans.map((plan: any) => (
          <HolographicCard key={plan.name} className="p-5">
