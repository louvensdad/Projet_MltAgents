...
## Stack & Versoes
- **Stack principal:** Node + NestJS
- **Versao do Node.js:** {node_version}
...
- npm install && npm run build deve passar
- Testes devem passar
- Nenhum codigo de outro stack (Java, Python, PHP, C#)

## Criterios de Download
- Projeto compilavel com npm/yarn/pnpm
- tsconfig.json configurado
- Dockerfile e docker-compose.yml se Docker foi solicitado

## Gatekeepers Ativos
- Stack Gate → verifica se e Node + NestJS
